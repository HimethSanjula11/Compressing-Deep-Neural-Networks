...
print("="*80)
print("PROFESSIONAL ALEXNET FP32 BASELINE TRAINING")
...
class ProfessionalAlexNetAnalyzer:
    """Professional AlexNet training & analysis class (FP32 baseline, stabilized)"""

    def __init__(self, experiment_name="AlexNet_FP32_Baseline"):
        self.device = device
    ...
    def generate_layer_analysis_table(self):
        if "layer_breakdown" in self.model_metrics:
            ...
            latex = df.to_latex(index=False, escape=False,
                                caption="AlexNet FP32 Layer-wise Parameter Analysis",
                                label="tab:alexnet_layer_analysis")
    ...
    def generate_professional_text_report(self, report):
        ...
        with open(f"{self.results_dir}/executive_summary.txt", "w") as f:
            f.write("="*80 + "\n")
            f.write("ALEXNET FP32 BASELINE - EXECUTIVE SUMMARY\n")
        ...
        with open(f"{self.results_dir}/professional_report.txt", "w") as f:
            f.write("="*100 + "\n")
            f.write("ALEXNET FP32 BASELINE - COMPREHENSIVE ANALYSIS REPORT\n")
            f.write("MSc Artificial Intelligence Dissertation Project\n")
            f.write("="*100 + "\n\n")
            ...
            f.write("-"*50 + "\n")
            f.write("This FP32 AlexNet model serves as the reference baseline for:\n")
...
def main():
    print("Starting Professional AlexNet FP32 Baseline Training...\n")
    analyzer = ProfessionalAlexNetAnalyzer("AlexNet_FP32_Baseline")
    ...
    try:
        ...
        # 8) Summary
        print("\n" + "="*80)
        print("ALEXNET FP32 BASELINE TRAINING COMPLETED SUCCESSFULLY")
        print("="*80)
